package com.isa.kapilanguagelearning.spanish.spanishVerbForms
...
import kotlinx.android.synthetic.main.activity_verb_forms_spanish.*


class VerbFormsSpanishActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_verb_forms_spanish)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        text_view_present_spanish.setOnClickListener {
            val intent = Intent(this, PresentSpanishActivity::class.java)
            startActivity(intent)
        }
        text_view_past_spanish.setOnClickListener {
            val intent = Intent(this, PastSpanishActivity::class.java)
            startActivity(intent)
        }
        text_view_future_spanish.setOnClickListener {
            val intent = Intent(this, FutureSpanishActivity::class.java)
            startActivity(intent)
        }
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.miItem4 -> {
                Toast.makeText(baseContext, "You clicked on About the app", Toast.LENGTH_SHORT)
                    .show()
                true
            }
            ...
            R.id.subItemAbout1 -> {
                ...
                startActivity(intent)
                Toast.makeText(baseContext, "You clicked on About the creator", Toast.LENGTH_SHORT)
                    .show()
                true
            }
            R.id.subItemAbout2 -> {
