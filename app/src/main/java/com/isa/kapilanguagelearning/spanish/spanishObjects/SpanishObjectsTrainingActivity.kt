...
import kotlinx.android.synthetic.main.activity_spanish_objects_training.*

class SpanishObjectsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_spanish_objects_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_objects_spanish.setOnClickListener {
            val intent = Intent(this, SpanishObjectsActivity::class.java)
            val intentBefore = Intent(this, SpanishWeatherTrainingActivity::class.java)
