...
import kotlinx.android.synthetic.main.activity_spanish_occupations_training.*

class SpanishOccupationsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_spanish_occupations_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_occupations_spanish.setOnClickListener {
            val intent = Intent(this, SpanishOccupationsActivity::class.java)
            val intentBefore = Intent(this, SpanishObjectsTrainingActivity::class.java)
