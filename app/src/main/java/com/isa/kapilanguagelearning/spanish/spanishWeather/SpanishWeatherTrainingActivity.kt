...
import kotlinx.android.synthetic.main.activity_spanish_weather_training.*

class SpanishWeatherTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_spanish_weather_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_weather_spanish.setOnClickListener {
            val intent = Intent(this, SpanishWeatherActivity::class.java)
            val intentBefore = Intent(this, SpanishDirectionsTrainingActivity::class.java)
