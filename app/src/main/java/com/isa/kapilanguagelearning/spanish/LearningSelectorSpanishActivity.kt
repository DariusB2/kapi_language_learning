...
import com.isa.kapilanguagelearning.spanish.spanishChatBot.SpanishChatBotActivity
import com.isa.kapilanguagelearning.spanish.spanishVerbForms.VerbFormsSpanishActivity
import kotlinx.android.synthetic.main.activity_learning_selector_spanish.*

class LearningSelectorSpanishActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_learning_selector_spanish)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        text_view_facts_viewer_spanish.setOnClickListener {
            val intent = Intent(this, FactsSpanishActivity::class.java)
            startActivity(intent)
        }
        text_view_verbs_forms_viewer_spanish.setOnClickListener {
            val intent = Intent(this, VerbFormsSpanishActivity::class.java)
            startActivity(intent)
        }
        text_view_visitable_places_viewer_spanish.setOnClickListener {
            val intent = Intent(this, VisitablePlacesSpanishActivity::class.java)
            startActivity(intent)
        }
        text_view_start_learning_spanish.setOnClickListener {
            val intent = Intent(this, StartLearningSpanishActivity::class.java)
            startActivity(intent)
        }
        text_view_chat_bot_spanish.setOnClickListener {
            val intent = Intent(this, SpanishChatBotActivity::class.java)
            startActivity(intent)
        }
    }
