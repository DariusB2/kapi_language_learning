...
import kotlinx.android.synthetic.main.activity_spanish_date_training.*

class SpanishDateTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_spanish_date_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_date_spanish.setOnClickListener {
            val intent = Intent(this, SpanishDateActivity::class.java)
            val intentBefore = Intent(this, SpanishTimeTrainingActivity::class.java)
