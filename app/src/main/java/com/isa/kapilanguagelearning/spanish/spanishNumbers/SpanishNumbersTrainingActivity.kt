...
import kotlinx.android.synthetic.main.activity_spanish_numbers_training.*

class SpanishNumbersTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_spanish_numbers_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_numbers_spanish.setOnClickListener {
            val intent = Intent(this, SpanishNumbersActivity::class.java)
            val intentBefore = Intent(this, SpanishColorsTrainingActivity::class.java)
