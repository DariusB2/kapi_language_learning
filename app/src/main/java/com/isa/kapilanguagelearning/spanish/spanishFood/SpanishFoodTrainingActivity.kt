...
import kotlinx.android.synthetic.main.activity_spanish_food_training.*

class SpanishFoodTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_spanish_food_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_food_spanish.setOnClickListener {
            val intent = Intent(this, SpanishFoodActivity::class.java)
