...
import kotlinx.android.synthetic.main.activity_spanish_animals_training.*

class SpanishAnimalsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_spanish_animals_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_animals_spanish.setOnClickListener {
            val intent = Intent(this, SpanishAnimalsActivity::class.java)
            val intentBefore = Intent(this, SpanishFoodTrainingActivity::class.java)
