...
import kotlinx.android.synthetic.main.activity_spanish_colors_training.*

class SpanishColorsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_spanish_colors_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_colors_spanish.setOnClickListener {
            val intent = Intent(this, SpanishColorsActivity::class.java)
            val intentBefore = Intent(this, SpanishBodyTrainingActivity::class.java)
