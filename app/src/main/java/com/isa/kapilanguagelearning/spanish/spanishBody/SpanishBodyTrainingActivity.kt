...
import kotlinx.android.synthetic.main.activity_spanish_body_training.*

class SpanishBodyTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_spanish_body_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_body_spanish.setOnClickListener {
            val intent = Intent(this, SpanishBodyActivity::class.java)
            val intentBefore = Intent(this, SpanishHouseTrainingActivity::class.java)
