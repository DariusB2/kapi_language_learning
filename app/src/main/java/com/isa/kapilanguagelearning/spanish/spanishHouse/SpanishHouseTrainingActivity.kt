...
import kotlinx.android.synthetic.main.activity_spanish_house_training.*

class SpanishHouseTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_spanish_house_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_house_spanish.setOnClickListener {
            val intent = Intent(this, SpanishHouseActivity::class.java)
            val intentBefore = Intent(this, SpanishFamilyTrainingActivity::class.java)
