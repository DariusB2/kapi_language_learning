...
import kotlinx.android.synthetic.main.activity_spanish_time_training.*

class SpanishTimeTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_spanish_time_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_time_spanish.setOnClickListener {
            val intent = Intent(this, SpanishTimeActivity::class.java)
            val intentBefore = Intent(this, SpanishNumbersTrainingActivity::class.java)
