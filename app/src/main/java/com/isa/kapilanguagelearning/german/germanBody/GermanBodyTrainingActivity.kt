...
import kotlinx.android.synthetic.main.activity_german_body_training.*

class GermanBodyTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_german_body_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_body.setOnClickListener {
            val intent = Intent(this, GermanBodyActivity::class.java)
            val intentBefore = Intent(this, GermanHouseTrainingActivity::class.java)
