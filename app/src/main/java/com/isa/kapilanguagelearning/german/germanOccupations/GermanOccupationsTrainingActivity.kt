...
import kotlinx.android.synthetic.main.activity_german_occupations_training.*

class GermanOccupationsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_german_occupations_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_occupations.setOnClickListener {
            val intent = Intent(this, GermanOccupationsActivity::class.java)
            val intentBefore = Intent(this, GermanObjectsTrainingActivity::class.java)
