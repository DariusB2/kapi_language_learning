...
import kotlinx.android.synthetic.main.activity_german_family_training.*

class GermanFamilyTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_german_family_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_family.setOnClickListener {
            val intent = Intent(this, GermanFamilyActivity::class.java)
            val intentBefore = Intent(this, GermanAnimalsTrainingActivity::class.java)
