...
import kotlinx.android.synthetic.main.activity_german_weather_training.*

class GermanWeatherTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_german_weather_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_weather.setOnClickListener {
            val intent = Intent(this, GermanWeatherActivity::class.java)
            val intentBefore = Intent(this, GermanDirectionsTrainingActivity::class.java)
