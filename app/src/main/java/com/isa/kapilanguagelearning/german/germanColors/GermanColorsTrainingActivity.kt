...
import kotlinx.android.synthetic.main.activity_german_colors_training.*

class GermanColorsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_german_colors_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_colors.setOnClickListener {
            val intent = Intent(this, GermanColorsActivity::class.java)
            val intentBefore = Intent(this, GermanBodyTrainingActivity::class.java)
