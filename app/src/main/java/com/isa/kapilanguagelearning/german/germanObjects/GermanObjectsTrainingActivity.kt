...
import kotlinx.android.synthetic.main.activity_german_objects_training.*

class GermanObjectsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_german_objects_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_objects.setOnClickListener {
            val intent = Intent(this, GermanObjectsActivity::class.java)
            val intentBefore = Intent(this, GermanWeatherTrainingActivity::class.java)
