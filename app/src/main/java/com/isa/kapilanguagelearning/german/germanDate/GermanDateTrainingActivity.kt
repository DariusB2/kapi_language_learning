...
import kotlinx.android.synthetic.main.activity_german_date_training.*

class GermanDateTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_german_date_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_date.setOnClickListener {
            val intent = Intent(this, GermanDateActivity::class.java)
            val intentBefore = Intent(this, GermanTimeTrainingActivity::class.java)
