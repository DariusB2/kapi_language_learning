package com.isa.kapilanguagelearning.german.germanDirections
...
class GermanDirectionsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_german_directions_training)
