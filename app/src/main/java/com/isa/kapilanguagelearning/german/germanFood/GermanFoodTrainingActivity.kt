...
import kotlinx.android.synthetic.main.activity_german_food_training.*

class GermanFoodTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_german_food_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_food.setOnClickListener {
            val intent = Intent(this, GermanFoodActivity::class.java)
