...
import kotlinx.android.synthetic.main.activity_german_animals_training.*

class GermanAnimalsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_german_animals_training)
        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_animals.setOnClickListener {
            val intent = Intent(this, GermanAnimalsActivity::class.java)
            val intentBefore = Intent(this, GermanFoodTrainingActivity::class.java)
            val builder = AlertDialog.Builder(this)
            builder.setTitle("Are you sure?")
            builder.setMessage("Better try completing the quiz before this.")
            builder.setPositiveButton("Yes, I am ready!")
            { _: DialogInterface, _: Int ->
                startActivity(intent)
            }
            builder.setNegativeButton("Not ready! (previous quiz)")
            { _: DialogInterface, _: Int ->
                startActivity(intentBefore)
            }
            builder.setNeutralButton("I want to stay here and study!")
            { _: DialogInterface, _: Int -> }
            builder.show()
        }
    }
