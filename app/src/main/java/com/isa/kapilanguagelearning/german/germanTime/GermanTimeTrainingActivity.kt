...
import kotlinx.android.synthetic.main.activity_german_time_training.*

class GermanTimeTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_german_time_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_time.setOnClickListener {
            val intent = Intent(this, GermanTimeActivity::class.java)
            val intentBefore = Intent(this, GermanNumbersTrainingActivity::class.java)
