...
import kotlinx.android.synthetic.main.activity_german_house_training.*

class GermanHouseTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_german_house_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_house.setOnClickListener {
            val intent = Intent(this, GermanHouseActivity::class.java)
            val intentBefore = Intent(this, GermanFamilyTrainingActivity::class.java)
