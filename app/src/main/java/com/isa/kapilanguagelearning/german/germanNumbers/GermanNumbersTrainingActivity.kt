...
import kotlinx.android.synthetic.main.activity_german_numbers_training.*

class GermanNumbersTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_german_numbers_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_numbers.setOnClickListener {
            val intent = Intent(this, GermanNumbersActivity::class.java)
            val intentBefore = Intent(this, GermanColorsTrainingActivity::class.java)
