...
import kotlinx.android.synthetic.main.activity_romanian_numbers_training.*

class RomanianNumbersTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_romanian_numbers_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_numbers_romanian.setOnClickListener {
            val intent = Intent(this, RomanianNumbersActivity::class.java)
            val intentBefore = Intent(this, RomanianColorsTrainingActivity::class.java)
