...
import kotlinx.android.synthetic.main.activity_romanian_occupations_training.*

class RomanianOccupationsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_romanian_occupations_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_occupations_romanian.setOnClickListener {
            val intent = Intent(this, RomanianOccupationsActivity::class.java)
            val intentBefore = Intent(this, RomanianObjectsTrainingActivity::class.java)
