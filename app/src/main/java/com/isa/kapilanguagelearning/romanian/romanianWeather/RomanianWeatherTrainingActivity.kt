...
import kotlinx.android.synthetic.main.activity_romanian_weather_training.*

class RomanianWeatherTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_romanian_weather_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_weather_romanian.setOnClickListener {
            val intent = Intent(this, RomanianWeatherActivity::class.java)
            val intentBefore = Intent(this, RomanianDirectionsTrainingActivity::class.java)
