...
import kotlinx.android.synthetic.main.activity_romanian_food_training.*

class RomanianFoodTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_romanian_food_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_food_romanian.setOnClickListener {
            val intent = Intent(this, RomanianFoodActivity::class.java)
