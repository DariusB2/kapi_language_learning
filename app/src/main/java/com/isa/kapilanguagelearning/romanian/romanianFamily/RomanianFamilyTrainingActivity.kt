...
import kotlinx.android.synthetic.main.activity_romanian_family_training.*

class RomanianFamilyTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_romanian_family_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_family_romanian.setOnClickListener {
            val intent = Intent(this, RomanianFamilyActivity::class.java)
            val intentBefore = Intent(this, RomanianAnimalsTrainingActivity::class.java)
