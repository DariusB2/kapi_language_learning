package com.isa.kapilanguagelearning.romanian.romanianDirections
...
class RomanianDirectionsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_romanian_directions_training)
