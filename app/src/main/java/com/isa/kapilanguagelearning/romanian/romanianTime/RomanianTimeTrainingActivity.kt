...
import kotlinx.android.synthetic.main.activity_romanian_time_training.*

class RomanianTimeTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_romanian_time_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_time_romanian.setOnClickListener {
            val intent = Intent(this, RomanianTimeActivity::class.java)
            val intentBefore = Intent(this, RomanianNumbersTrainingActivity::class.java)
