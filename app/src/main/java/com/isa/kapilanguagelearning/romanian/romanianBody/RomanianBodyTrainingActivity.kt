...
import kotlinx.android.synthetic.main.activity_romanian_body_training.*

class RomanianBodyTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_romanian_body_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_body_romanian.setOnClickListener {
            val intent = Intent(this, RomanianBodyActivity::class.java)
            val intentBefore = Intent(this, RomanianHouseTrainingActivity::class.java)
