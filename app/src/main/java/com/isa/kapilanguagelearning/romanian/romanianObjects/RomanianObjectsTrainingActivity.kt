...
import kotlinx.android.synthetic.main.activity_romanian_objects_training.*

class RomanianObjectsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_romanian_objects_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_objects_romanian.setOnClickListener {
            val intent = Intent(this, RomanianObjectsActivity::class.java)
            val intentBefore = Intent(this, RomanianWeatherTrainingActivity::class.java)
