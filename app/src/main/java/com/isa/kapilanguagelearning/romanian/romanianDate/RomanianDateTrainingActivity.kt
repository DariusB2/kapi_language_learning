...
import kotlinx.android.synthetic.main.activity_romanian_date_training.*

class RomanianDateTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_romanian_date_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_date_romanian.setOnClickListener {
            val intent = Intent(this, RomanianDateActivity::class.java)
            val intentBefore = Intent(this, RomanianTimeTrainingActivity::class.java)
