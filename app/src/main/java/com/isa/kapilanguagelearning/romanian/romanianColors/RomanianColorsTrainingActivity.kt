...
import kotlinx.android.synthetic.main.activity_romanian_colors_training.*

class RomanianColorsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_romanian_colors_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_colors_romanian.setOnClickListener {
            val intent = Intent(this, RomanianColorsActivity::class.java)
            val intentBefore = Intent(this, RomanianBodyTrainingActivity::class.java)
