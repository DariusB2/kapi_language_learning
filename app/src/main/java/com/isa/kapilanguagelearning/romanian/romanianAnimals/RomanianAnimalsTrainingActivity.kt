...
import kotlinx.android.synthetic.main.activity_romanian_animals_training.*

class RomanianAnimalsTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_romanian_animals_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_animals_romanian.setOnClickListener {
            val intent = Intent(this, RomanianAnimalsActivity::class.java)
            val intentBefore = Intent(this, RomanianFoodTrainingActivity::class.java)
