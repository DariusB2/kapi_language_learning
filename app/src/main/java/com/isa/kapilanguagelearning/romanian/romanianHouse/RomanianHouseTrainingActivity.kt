...
import kotlinx.android.synthetic.main.activity_romanian_house_training.*

class RomanianHouseTrainingActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_romanian_house_training)

        preferences = getSharedPreferences("SHARED_PREF", Context.MODE_PRIVATE)

        button_start_quiz_house_romanian.setOnClickListener {
            val intent = Intent(this, RomanianHouseActivity::class.java)
            val intentBefore = Intent(this, RomanianFamilyTrainingActivity::class.java)
